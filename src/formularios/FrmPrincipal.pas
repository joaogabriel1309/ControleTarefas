...
uses FrmUsuario, FrmLogin, frmTarefa, TTarefa, FrmAtribuicao,
  TUsuario, TUsuarioTarefa, frmPesquisaUsuario;
...
procedure TFormMain.ImageUsuarioClick(Sender: TObject);
var
