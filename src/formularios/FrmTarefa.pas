...
uses TTarefa, TUsuario, frmPesquisaTarefa;
...
begin
  ...
  begin
    ...
    begin
      ...
      case fTarefa.Tipo[1] of
        'D': ComboBoxTipo.ItemIndex := 0;
        'S': ComboBoxTipo.ItemIndex := 1;
        'Q': ComboBoxTipo.ItemIndex := 2;
        'M': ComboBoxTipo.ItemIndex := 3;
      else
...
procedure TfrmTarefas.ImagePesquisaClick(Sender: TObject);
var
